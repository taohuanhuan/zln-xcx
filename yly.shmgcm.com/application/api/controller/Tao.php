...
class TaobaoController extends Api
{
    // 公共配置项
    protected static $vekey = 'V89656601M40175929';  // 替换成你的 vekey
    ...
    {
        // 获取请求参数
        $param = $request->param('param', 'default_value'); // 获取 'param' 参数，默认值为 'default_value'
