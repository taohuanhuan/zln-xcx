	...
	<view style="width: 690rpx;">
		...
		<view class="ctop" >
			...
			<view class="kycontainer">
				<view class="left-text" @click="gokysj">可约时间</view>
				<view class="divider"></view>
				<view class="right-text" @click="gofklc">服务流程</view>
			</view>
		</view>


		<view class="instructor-item">
			<image class="instructor-image" src="../../static/img/iil.png"></image>
			<view class="instructor-info">
				<text class="instructor-name">安肯心理咨询（宝安中心店）</text>
				<text class="instructor-bio">湖北省恩施土家族苗族自治州咸丰县仁廉路273号></text>
			</view>
		</view>

		<view class="" style="margin-bottom: 30rpx;">

			<custom-component title="个人介绍" :show-description="false" description="" icon-name="arrow" class="m-b-20"
				:navigateToUrl="''" style="margin: 30rpx 0;">
				<template v-slot:bottom-content>
					<image style="height: auto;margin:0 30rpx;width:630rpx;" mode="widthFix"
						src="../../static/img/kct.png">
					</image>

					<view class="" style="font-size:  28rpx;
				color: #666666; padding: 30rpx;">

						安肯心理是一家全国连锁的医学心理健康服务机构。我们安肯人以“为亿万中国家庭提供私家心理医生服务”为使命。为4-60岁人群的心理困扰(例如亲子、婚恋、职场、人际等)和心理疾病(例如多动、抑郁焦虑、失眠等)，提供药物心理物理一站式解决方案。
					</view>
...
<script>
	export default {
		...
		methods: {
			...
			gofklc() {
				uni.navigateTo({
					url: '/pages/supervision/service_process'
				});
			},
			goyy() {
				wx.navigateTo({
