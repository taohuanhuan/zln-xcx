<template>
	<view class="container" style="width:690rpx">
		...
		<view class="counselor-item" @click="goxq">
			...
			<view class="counselor-info">
				...
				<view class="counselor-name-row">
					...
					<u-tag size="mini" :borderColor="'#F19436'" :bg-color="'#FFEEDE'" :color="'#F19436'" class="m-l-10" text="收录5年">
					</u-tag>
				</view>
				<text class="counselor-detail" style="color: #999999;">简介：<text
						style="color: #555555;">不要以“为别人考虑”做理由，其实丢弃了“舍我其谁”的使命感
					</text></text>
...
<script>
	export default {
		...
		methods: {
			...
			goxq(){
				uni.navigateTo({
					url: '/pages/supervision/consultant_details'
				});
			},
		}
	}
