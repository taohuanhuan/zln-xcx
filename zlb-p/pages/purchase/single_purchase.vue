					...
					<view class="course-list-item">
						...
						font-size: 30rpx; color: #242424; font-weight: bold;">
								...
								<view class="" style="display: flex;">
									...
									<view style="margin-right: 20rpx;">
										<u-tag :borderColor="'#F19436'" :bg-color="'#FFEEDE'" :color="'#F19436'"
											size="mini" class="m-l-10" text="新课首发"></u-tag></u-tag>
									</view>
							...
							<view class="course-pricing m-l-10">
								<view class="price-discount">¥39.9</view>
								<view class="price-original">¥69.9</view>
							</view>
						</view>
					</view>
			...
			<template v-slot:bottom-content>
				...
				<view class="fee-info">
					<view class="fee-row">
						...
						<view class="right price">￥39.9</view>
					</view>
					<view class="fee-row">
					...
					<view class="fee-row">
						...
						<view class="right total fee-row">
							...
							<view class="total-price">￥39.9</view>
						</view>
					</view>
				</view>
